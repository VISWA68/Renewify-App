...
class _SolarElectricityState extends State<SolarElectricity> {
  ...
  void initState() {
    ...
    // Start the timer to fetch data every 4 seconds
...
Container(
  ...
  child: Column(
    ...
    children: [
      ...
      ElevatedButton(
        onPressed: () {
          // Implement the action for raising a complaint
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => ComplaintPage()), // Replace with your actual ComplaintPage
          );
        },
